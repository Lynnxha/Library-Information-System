        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li><a href="#about"></a></li> <!-- Biarkan Jangan Di Hapus-->
            </ul>        
          </nav>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-lg-6 align-self-center">
              <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                <div class="row">
                  <div class="col-lg-12">
                    <h2 class="text-white">Selamat Datang Di Perpustakaan Online SMK PGRI 3 MALANG</h2>
                  </div>
                  <div class="col-lg-12">
                    <br>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="service-item first-service">
            <div class="icon"></div>
            <h4>Buku Populer</h4>
            <p>Perpustakaan kami memiliki Koleksi-koleksi Buku Populer yang sering dibaca pengunjung perpustakaan.</p>
        ...
        <div class="col-lg-4">
          <div class="service-item second-service">
            ...
            <p>Para anggota dapat melakukan pengembalian buku yang dipinjam secara online.</p>
            <div class="text-button">
              <a href="#">Read More <i class="fa fa-arrow-right"></i></a>
            </div>
          </div>
        ...
        <div class="col-lg-4">
          <div class="service-item fourth-service">
            ...
            <p>Para anggota perpustakaan dapat melakukan peminjaman buku yang ingin dipinjam secara online.</p>
            <div class="text-button">
              <a href="#">Read More <i class="fa fa-arrow-right"></i></a>
            </div>
          </div>
